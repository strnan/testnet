...
echo -e "Nama chain kamu: \e[1m\e[32m$QUICKSILVER_CHAIN_ID\e[0m"
echo -e "Port kamu: \e[1m\e[32m$QUICKSILVER_PORT\e[0m"
echo '================================================='
sleep 2

echo -e "\e[1m\e[32m1. Memperbarui aplikasi... \e[0m" && sleep 1
# update
sudo apt update && sudo apt upgrade -y

echo -e "\e[1m\e[32m2. Sedang install aplikasi yang diperlukan... \e[0m" && sleep 1
# packages
